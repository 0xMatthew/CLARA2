...
If you want a more detailed technical breakdown of how CLARA 2 works, check out [ARCHITECTURE.md](ARCHITECTURE.md).
...
2. Launch Audio2Face as a headless server by clicking the hamburger icon pictured below:
    ...
    ![hamburger icon](image.png)

3. Click settings:

    ![settings button](image-1.png)

4. Click the folder icon:

    ![folder icon](image-2.png)

5. Launch `audio2face_headless.bat` using your favorite Windows shell:

    ![audio2face_headless.bat](image-3.png)
