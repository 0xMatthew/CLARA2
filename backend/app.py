...
def stop_audio2face():
    try:
        ...
        # command to start a new instance of audio2face, must be changed to point to your audio2face_headless.bat location if you want to use the Debugging stop/restart A2F feature in the UI
